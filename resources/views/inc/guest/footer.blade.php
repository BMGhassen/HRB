...
<script src="{{asset('build/shopassets/lib/easing/easing.min.js')}}"></script>
<script src="{{asset('build/shopassets/lib/owlcarousel/owl.carousel.min.js')}}"></script>

<!-- Contact Javascript File -->
<script src="{{asset('build/shopassets/mail/jqBootstrapValidation.min.js')}}"></script>
<script src="{{asset('build/shopassets/mail/contact.js')}}"></script>

<!-- Template Javascript -->
<script src="{{asset('build/shopassets/js/main.js')}}"></script>
